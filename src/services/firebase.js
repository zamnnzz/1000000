...
if (!firebase) throw new Error("Firebase SDK لم يتم تحميله");
...
export const updateOnlinePlayer = async ({ phone = null, playerName = null, currentGameId = null, currentGameName = null } = {}) => {
    try {
...
export const registerGameEntry = async (game, phone, playerName, entryType) => {
    if (!game)
        return;
