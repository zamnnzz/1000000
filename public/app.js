...
function openCreate(){joinMode='create';$('nameTitle').textContent='اسم المضيف';$('codeInput').classList.add('hidden');$('confirmJoinBtn').textContent='إنشاء الغرفة';$('switchModeBtn').textContent='دخول جلسة';$('nameInput').value='';show('nameScreen')}
function openJoin(){joinMode='join';$('nameTitle').textContent='دخول غرفة';$('codeInput').classList.remove('hidden');$('confirmJoinBtn').textContent='دخول';$('switchModeBtn').textContent='إنشاء جلسة';$('nameInput').value='';$('codeInput').value=(new URL(location.href).searchParams.get('room')||'').toUpperCase();show('nameScreen')}
...
$('switchModeBtn').onclick=()=>joinMode==='join'?openCreate():openJoin();
